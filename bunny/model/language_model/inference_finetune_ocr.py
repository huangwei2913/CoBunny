...
#MODEL_PATH = '/mnt/CoBunny/checkpoints-stage3/ocrmodel'

MODEL_PATH = '/mnt/CoBunny/checkpoints-stage3/bunny-phi1.5-full-forzeLLM_ocr/final_ocr_direct_merge_3.9G'
...
def run_inference():
    ...
    # 1. 获取所有参数名及其形状、是否参与训练的状态
    print(f"\n{'='*100}\n{'Model Parameter Full List':^100}\n{'='*100}")
    for name, param in model.named_parameters():
        print(f"Parameter: {name:<75} | Shape: {str(list(param.shape)):<20} | Requires_Grad: {param.requires_grad}")
    print(f"{'='*100}\nTotal Parameters Count: {len(list(model.parameters()))}\n{'='*100}\n")

    # inference_finetune_ocr.py 中的修改建议
