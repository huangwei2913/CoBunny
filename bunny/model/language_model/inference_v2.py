...
# 配置
MODEL_PATH = '/mnt/CoBunny/checkpoints-stage3/bunny-phi1.5-full-finetune-final/checkpoint-3303-FULL-FIXED'
...
# --- 调用部分 ---
# prompt = "A detailed description of <img_content>"
...
def run_inference():
    ...
    input_ids = tokenizer_image_token_custom(text, tokenizer, IMAGE_TOKEN_INDEX).to(DEVICE)
