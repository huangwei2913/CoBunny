...
def _make_dinov2_model(
    ...
    **kwargs,
    ...
    model_dir = "/home/huangwei/unik3d-vits"  #这个可能是不对的，现在我只是做测试用
    weight_path = os.path.join(model_dir, 'dinov2_vits14_pretrain.pth')
    state_dict = torch.load(weight_path, map_location='cpu')
    model.load_state_dict(state_dict, strict=False)
    
    print(f"DINOv2 loaded from {pretrained} with info:", weight_path)
