...
BASE_MODEL="/mnt/conda_data/checkpoints-finetuned/bunny-qwen2_finally"
OUTPUT_DIR="/mnt/conda_data/checkpoints-stage3/bunny-qwen-sampler_tuned"
#DATA_PATH="/mnt/conda_data/Bunny-v1.1-data/finetune/Bunny_Stage2_Color_Refine_v3.json"
#只微调OCR看下是什么情况
DATA_PATH="/mnt/CoBunny/dataassert/ocr_5_ready_fixed_invalid.json"
...
deepspeed \
    ...
    bunny/train/train_stage4_qwen2.py \
