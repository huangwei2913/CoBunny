...
BASE_MODEL="/mnt/conda_data/checkpoints-pretrain/pretrain_llama_architecutre_revised_proj/checkpoint-2000"
BASE_MODEL="/mnt/CoBunny/checkpoints-stage3/llama_ocr"


#由于重新开有问题，那我们就
# [输出] Stage 3 的保存位置
OUTPUT_DIR="./checkpoints-stage3/bunny-llama-full-finetune_"

# [数据] Stage 3 的高质量混合数据
DATA_PATH="/mnt/CoBunny/dataassert/cobunny_stage2_final_pure_ocr_en.json"
IMAGE_PATH="/"
...
deepspeed \
    ...
    --mm_projector_type cobunny_structured \
