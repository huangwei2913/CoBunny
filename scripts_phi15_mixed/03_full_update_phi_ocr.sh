...
#BASE_MODEL="/mnt/conda_data/checkpoints-pretrain/pretrain_stage1_ocr_enhanced/checkpoint-31947"
BASE_MODEL="/mnt/conda_data/checkpoints-pretrain/pretrain_stage1_ocr_hard/checkpoint-29000"

#由于重新开有问题，那我们就
# [输出] Stage 3 的保存位置
OUTPUT_DIR="./checkpoints-stage3/bunny-phi1.5-full-specilized_ocr_optimized"

# [数据] Stage 3 的高质量混合数据
#DATA_PATH="/data/Zebra-CoT/zebra_sft_stage2.json"
#DATA_PATH="/data/ShareGPT4V/sharegpt4v_vg_only_clean.json"
#DATA_PATH="/data/fashion/FashionRec/fashion_visual_alignment_gold.json"
#DATA_PATH="/mnt/CoBunny/dataassert/echo4o_hard_vqa_refined_abspath.json"
#DATA_PATH="/mnt/CoBunny/dataassert/blip3o_final_sft_abs.json"
#DATA_PATH="/mnt/CoBunny/dataassert/ocr_en_only_stage3.json"
...
# 区别：关闭 LoRA，开启全参数更新
#这里直接冻住所有LLM，下一步如果不行的话，直接干LLM的lora的
deepspeed \
    --hostfile $HOSTFILE \
    --include "$INCLUDE_STR" \
    ...
    --deepspeed ./script/deepspeed/zero3_full_ocr_finetune.json \
